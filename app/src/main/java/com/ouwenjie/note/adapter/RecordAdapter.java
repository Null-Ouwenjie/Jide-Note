 ...
 */
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.ViewHolder> implements View.OnClickListener ,View.OnLongClickListener{
    ...
    public RecordAdapter(Context context,List<BaseNote> noteList){
        super();
    ...
    public BaseNote getNotebyLastChangedDate(String lastChangedDate){
        for(BaseNote note : noteList ){
            if(note.getLastChangeDate().equals(lastChangedDate)){
                return note;
            }
        }
        return null;
    ...
    public RecordAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.layout_item_note,viewGroup,false);
